...
public class FormulaEditorListFragment extends SherlockListFragment implements Dialog.OnKeyListener {
	...
	private static final int[] SENSOR_ITEMS_WITH_PHIRO = { R.string.formula_editor_sensor_x_acceleration,
			...
			R.string.formula_editor_sensor_face_detected, R.string.formula_editor_sensor_face_size,
			R.string.formula_editor_sensor_face_x_position, R.string.formula_editor_sensor_face_y_position,
			R.string.formula_editor_phiro_sensor_front_left, R.string.formula_editor_phiro_sensor_front_right,
			R.string.formula_editor_phiro_sensor_side_left, R.string.formula_editor_phiro_sensor_side_right,
